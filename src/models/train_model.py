"""
Trains a spam classifier (Logistic Regression) using TF-IDF features
and saves the final model to models/spam_clf.joblib
"""
import logging
...
from src.features.build_features import build_feature_matrix, save_vectorizer
